        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {testimonials.map((item, index) => (
            <RevealOnScroll key={item.id} delay={index * 0.2}>
              <div className="group bg-[#0a0a0a] p-8 md:p-12 rounded-2xl border border-white/5 hover:border-white/10 transition-all duration-300 hover:-translate-y-2 relative h-full">
                ...
                <p className="font-sans text-gray-300 text-base md:text-lg leading-relaxed mb-8 md:mb-10 relative z-10">
                  “{item.quote}”
                </p>
                <div>
